...
namespace InfimaGames.LowPolyShooterPack.Interface
{
    ...
    public class ImageWeapon : Element
    {
        ...
        [Title(label: "Colors")] [Tooltip("Color applied to all images.")] [SerializeField]
        private Color imageColor = Color.white;

        [Title(label: "Settings")] [Tooltip("Weapon Body Image.")] [SerializeField]
        private Image imageWeaponBody;

        [Tooltip("Weapon Scope Default Image.")] [SerializeField]
        private bool useAttachments = true;
