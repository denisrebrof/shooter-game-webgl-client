...
namespace InfimaGames.LowPolyShooterPack
{
    ...
    public class CharacterKinematics : MonoBehaviour
    {
        ...
        public void UpdateLeftEffector(Vector3 pos)
        {
            armLeftTarget.localPosition = pos;
        }

        public void UpdateEffectors(Vector3 leftPos, Vector3 rightPos)
        {
            armLeftTarget.localPosition = leftPos;
            armRightTarget.localPosition = rightPos;
        }
