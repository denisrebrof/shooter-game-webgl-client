    ...
    public class Inventory : InventoryBehaviour
    {
        ...
        public override WeaponBehaviour Equip(int index)
        {
            ...
            if (equipped != null)
            {
                ...
                equipped.GetOnShootEvent().RemoveAllListeners();
            }
            
            //Update index.
            equippedIndex = index;
            var isSecondary = index > 0;
            OnWeaponEquipped(isSecondary);
            //Update equipped.
            equipped = weapons[equippedIndex];
            //Activate the newly-equipped weapon.
            equipped.gameObject.SetActive(true);
            equipped.GetOnShootEvent().AddListener(data => OnWeaponShoot(data, isSecondary));
            //Return.
            return equipped;
        }
        
        protected virtual void OnWeaponShoot(ShootEventData data, bool isSecondary)
        {
            
        }

        protected virtual void OnWeaponEquipped(bool isSecondary)
        {
