...
namespace FavouritesEd
{
    public class FavouritesTreeView : TreeViewWithTreeModel<FavouritesTreeElement>
    {
            ...
            if (args.performDrop)
            {
                ...
                else
                {
                    ...
                    foreach (Object obj in objs)
                    {
                        ...
                        asset.favs.Add(new FavouritesElement() { obj = obj, categoryId = categoryId });
                    }
                }
        ...
        private void AddToSceneFavs(GameObject go, int categoryId)
        {
            ...
            container.favs.Add(new FavouritesElement() { categoryId = categoryId, obj = go });
	...
	if (Invoke_folderIconName == null)
	{
		...
		PropertyInfo prop = asm
			.GetType("UnityEditorInternal.EditorResourcesUtility")
